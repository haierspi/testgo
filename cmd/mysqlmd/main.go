...
func init() {
	...
	prefix := flag.String("prefix", "*", "请输入 前缀 名称，默认为“*”，多个可用“,”分割\n")
...
func main() {
	...
	for _, table := range tables {
		...
		fmt.Println(tableSaveName)

		filepath := "./repository/db_repo/" + tableSaveName + "_repo"
		...
		fmt.Println("  └── file : ", tableSaveName+"_repo/gen_table.md")
		...
		fmt.Println("  └── file : ", tableSaveName+"_repo/gen_model.go")
